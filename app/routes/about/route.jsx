          ...
          <main className="main">
            <div className="containerB bgImg">
              <div className="containerC">
                <p className="textB">
                  Meet Chani, the purrfect embodiment of resilience and the
                  unbreakable spirit of feline kind. Rescued on September 4th,
                  2022, from the cruel fate of being abandoned on the side of
                  the road, Chani's journey is one of triumph against all odds.
                </p>
                <p className="textB">
                  With a broken back right leg and hip, the odds seemed stacked
                  against her. But with the unwavering love and care of her
                  human and the expertise of the vet, Chani defied the prognosis
                  and made a miraculous full recovery without the need for
                  amputation.
                </p>
                <p className="textB">
                ...
                <p className="textB">
                  ...
                  Her story is a testament to the power of love, resilience, and
                  the unbreakable bonds between humans and their furry
                  companions.
                </p>
              </div>
            </div>
